...
I've written before about how we should treat [prose and data with the same respect that developers treat code](https://blog.arcestia.my.id/2013/09/16/treat-data-as-code/) and how [Jekyll forces you to do just that](https://blog.arcestia.my.id/2013/10/30/content-is-king/), but there's another workflow that version-controlled, collaborative content enables: continuous integration.
